    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12 bg-dark text-white">
                <h1 align="center">DULARA AUTO DETAILING</h1>
            </div>
        </div>

        <div class="row">
            <div class="col-md-12 bg-dark text-white">
                <h5 align="center">The finest automobile service center in area</h5>
            </div>
        </div>
...
-->
        ...
        <div class="row">
            <div class="col-md-4 text-center bg-dark text-white" id="div_left_side">


                <div id="div_image" class="container-fluid">
                    <img src="../includes/images/dulara_logo.jpg" class="rounded-circle" alt="Cinque Terre" width="304" height="236">
                </div>
                <div class="row">&nbsp;</div>
                <p>Welcome to the most finest set of auto-mobile services<br>in the area</p>
            ...
            <div class="col-md-8" id="div_right_side">
                <form method="POST" id="form_welcome_back" action="../controller/logincontroller.php?status=login">
                    <div class="row">
                        ...
                        <div class="form-group col-md-8">
                            <input class="form-control" type="email" placeholder="Username" name="username" id="input_id"  required="required">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-8">
                            <input class="form-control" type="password" placeholder="Password" name="password" id="input_password" required="required">
                        </div>
                        <h1 class="h4">
                ...
                <div class ="row">
                    <div class="col-md-6 text-center">
                        ...
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <a href="https://www.facebook.com/dularaimport" class="fa fa-facebook" target="_blank"></a>
